    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Padding(
        ...
        child: StatefulBuilder(builder: (c, setM) => Column(mainAxisSize: MainAxisSize.min, children: [
          Text("En que gastaste?", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18)),
          DropdownButton<String>(
            value: selected, 
            isExpanded: true, 
            onChanged: (v){ if(v!=null) setM(()=> selected=v); }, 
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              if(g>0){ 
                ...
                if(r>0) box.put('Colchon', box.get('Colchon') + r);
                setState((){}); 
                Navigator.pop(context); 
              }
            },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: Icon(Icons.delete_forever, color: Colors.red), onPressed: _borrarTodo)
        ],
      ),
      body: Padding(
        ...
        child: Column(children: [
          Container(
            ...
            padding: EdgeInsets.all(20), 
            decoration: BoxDecoration(color: Color(0xFF0E4D64), borderRadius: BorderRadius.circular(15), border: Border.all(width: 3)),
